...
{
	return Vector3(world._31, world._32, world._33); // z방향
}

Vector3 Mesh::Up()
{
	return Vector3(world._21, world._22, world._23); // y방향
}

Vector3 Mesh::Right()
{
	return Vector3(world._11, world._12, world._13); // x방향
}
...
void Mesh::UpdateWorld()
{
	...
	// D3DXMatrixRotationYawPitchRoll 함수는 x,y,z축을 한번에 회전시키는 것
	// 모든 축을 한번에 회전시키지 않으면 짐벌락 현상이 발생할 수 있음
